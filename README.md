...
| Klipper/Moonraker   | 192.168.2.CHANGEME | 7125                | `/server/prometheus/metrics`           |
| Supermicro BMC/IPMI | 192.168.2.CHANGEME | 9290 (via exporter) | `/metrics`                             |


**Note:** Replace `CHANGEME` IPs in the monitoring manifests with actual addresses:

- `apps/monitoring/components/netdata-klipper.yaml` -- Klipper/Moonraker IP
- `apps/monitoring/components/ipmi-exporter.yaml` -- BMC/IPMI IP addresses in `targets.yml`
